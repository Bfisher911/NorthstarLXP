import { Award, Download, Hourglass, ShieldCheck } from "lucide-react";
...
function CertCard({ c }: { c: ReturnType<typeof getCertificatesForUser>[number] }) {
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
              ...
              {c.expiresAt && <Badge variant={c.status === "expired" ? "destructive" : c.status === "expiring" ? "warning" : "success"}>
